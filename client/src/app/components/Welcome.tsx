...
const suggestions: SuggestionItem[] = [
  { 
    ...
    text: 'Plan a trip to Italy for family of 4 with 2 kids in May',
  ...
  { 
    ...
    text: 'Compare Iphone and Samsung Galaxy',
    subtitle: 'Get detailed pros and cons for each product'
  },
  { 
    icon: (
      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    text: 'Write a recipe for a chocolate cake',
    subtitle: 'Delicious and easy-to-follow instructions'
  },
  { 
    icon: (
      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    text: 'Create a calisthenics workout plan for beginners',
